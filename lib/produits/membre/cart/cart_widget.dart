...
import '/produits/membre/check/check_widget.dart';
                      ...
                      children: [
                        Padding(
                          padding: const EdgeInsetsDirectional.fromSTEB(
                              20.0, 0.0, 0.0, 0.0),
                          child: Text(
                            '${FFAppState().cartitems.toString()} item(s)',
                            style: FlutterFlowTheme.of(context)
                                .bodyMedium
                                .override(
                                  fontFamily: 'Poppins',
                          ...
                          itemBuilder: (context, cartitemsIndex) {
                            ...
                            return Padding(
                              ...
                              child: StreamBuilder<ProduitsRecord>(
                                stream:
                                    ProduitsRecord.getDocument(cartitemsItem),
                                              ...
                                              Padding(
                                                ...
                                                child: Column(
                                                  ...
                                                  children: [
                                                    ...
                                                    Text(
                                                      '${rowProduitsRecord.price.toString()} dnt',
                                                      style: FlutterFlowTheme
                                                              .of(context)
                                                          .bodyMedium
                                                          .override(
                        ...
                        child: FFButtonWidget(
                          onPressed: () async {
                            await actions.envoiMail(
                              'houssine',
                              'houssinebenarous59@gmail.com',
                              'confirmation d\'achat',
                              'votre commande succes',
                            );
