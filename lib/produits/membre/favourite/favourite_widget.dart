                    ...
                    Padding(
                      ...
                      child: StreamBuilder<List<FavorisRecord>>(
                        ...
                        builder: (context, snapshot) {
                          ...
                          List<FavorisRecord> listViewFavorisRecordList =
                              snapshot.data!;
                          return ListView.builder(
                            padding: EdgeInsets.zero,
                            shrinkWrap: true,
                            scrollDirection: Axis.vertical,
                            itemCount: listViewFavorisRecordList.length,
                            itemBuilder: (context, listViewIndex) {
                              final listViewFavorisRecord =
                                  listViewFavorisRecordList[listViewIndex];
                              return Row(
                                mainAxisSize: MainAxisSize.max,
                                children: [
                                  Flexible(
                                                    ...
                                                    padding:
                                                        const EdgeInsetsDirectional
                                                            .fromSTEB(0.0, 10.0,
                                                                0.0, 0.0),
                                                    child: Text(
                                                      '${listViewFavorisRecord.price.toString()} dnt',
                                                      style: FlutterFlowTheme
                                                              .of(context)
                                                          .bodyMedium
                                                          .override(
